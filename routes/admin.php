...
Route::group([
    ...
    Route::group(['prefix' => 'setup'], function () {
        ...
        Route::get('incomehead', [FinanceController::class, 'FinaenceInsomceHead']);
        Route::get('expence', [FinanceController::class, 'FinaenceExpenseHead']);
        Route::get('leave-type', [HumanResourceController::class, 'humanresourceleavesetup']);
        Route::get('department', [HumanResourceController::class, 'humanresourceDepartment']);
        Route::get('desingnation', [HumanResourceController::class, 'desingation']);
        Route::get('specalist', [HumanResourceController::class, 'Specalist']);
        Route::get('inventory-category', [InventoryController::class, 'InventoryCategory']);
        Route::get('itemstore', [InventoryController::class, 'Itemstore']);
        Route::get('supplier-inventory', [InventoryController::class, 'supplierInventory']);
        Route::get('referal-category', [ReferalController::class, 'Referalcategory']);
        Route::get('referal-commission', [ReferalController::class, 'ReferralCommission']);
        Route::get('symtoms-type', [SetupController::class, 'symtoms']);
        Route::get('symtoms-head', [SetupController::class, 'symtomsHead']);
