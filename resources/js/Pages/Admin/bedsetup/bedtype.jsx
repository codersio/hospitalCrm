...
const BedType = ({ admin }) => {
    ...
    const fetchData = () => {
        axios.post('/api/admin/bedtype-fetch').then(res => {
            console.log(res)
            setData(res.data)
    ...
    const handleSubmit = async (e) => {
        ...
        formSave.append('bed_type_name', formData.bed_type_name)
        ...
        try {
            const response = await axios.post('/api/admin/bedtype-store', formSave);
    ...
    const Updatedata = (e, id) => {
        ...
        axios.post(`/api/admin/bedtype-update/${id}`, formSave).then(res => fetchData()).catch(error => console.log(error))
    }
    const DeleteData = (e, id) => {
        e.preventDefault();

        axios.post(`/api/admin/bedtype-delete/${id}`)
            .then(response => {
                                                    ...
                                                    <td td className='px-6 py-3  text-xs flex space-x-2 text-end justify-end' >
                                                        <a onClick={() => {
                                                            setFormData({
                                                                ...
                                                                bed_type_name: datas.bed_type_name,
                                                                ...
                                                                <div className="modal-body">
                                                                    ...
                                                                    <form action className="w-full grid grid-cols-1 gap-5 px-6 mt-10 relative">
                                                                        <div className="form-group w-full ">
                                                                            ...
                                                                            <input onChange={handleChange} name='bed_type_name' value={formData.bed_type_name} type="text" className="w-full border-gray-300" />
                                                                        </div>
