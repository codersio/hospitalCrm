...
const Expenses = ({ admin }) => {
    ...
    const fetchData = () => {
        axios.post('/api/admin/expense-fetch')
            .then(res => {
    ...
    const FormSubmit = (e) => {
        ...
        axios.post('/api/admin/expense-store', formSave,)
            .then(response => {
    ...
    const DeleteData = (e, id) => {
        ...
        axios.post(`/api/admin/expense-delete/${id}`)
            .then(response => {
                console.log(response)
                fetchData();
            })
    ...
    const Updatedata = (e, id) => {
        ...
        formSave.append('date', formData.date)
        formSave.append('atach_file', atach_file)
        axios.post(`/api/admin/expense-update/${id}`, formSave).then(res => fetchData()).catch(error => console.log(error))
    }
    return (
