...
const ReferalCategory = ({ admin }) => {
    ...
    const fetchData = () => {
        axios.post('/api/admin/ReferralCategory-fetch').then(res => {
            console.log(res)
            setData(res.data)
    ...
    const handleSubmit = async (e) => {
        ...
        formSave.append('referral_cate_name', formData.referral_cate_name)
        ...
        try {
            const response = await axios.post('/api/admin/ReferralCategory-store', formSave);
    ...
    const Updatedata = (e, id) => {
        ...
        axios.post(`/api/admin/ReferralCategory-update/${id}`, formSave).then(res => fetchData()).catch(error => console.log(error))
    }
    const DeleteData = (e, id) => {
        e.preventDefault();

        axios.post(`/api/admin/ReferralCategory-delete/${id}`)
            .then(response => {
                                                    ...
                                                    <td td className='px-6 py-3  text-xs flex space-x-2 text-end justify-end' >
                                                        <a onClick={() => {
                                                            setFormData({
                                                                ...
                                                                referral_cate_name: datas.referral_cate_name,
                                                                ...
                                                                <div className="modal-body">
                                                                    ...
                                                                    <form action className="w-full grid grid-cols-1 gap-5 px-6 mt-10 relative">
                                                                        <div className="form-group w-full ">
                                                                            ...
                                                                            <input onChange={handleChange} name='referral_cate_name' value={formData.referral_cate_name} type="text" className="w-full border-gray-300" />
                                                                        </div>
...
export default ReferalCategory;