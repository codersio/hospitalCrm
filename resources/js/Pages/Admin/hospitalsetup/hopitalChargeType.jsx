...
const hopitalChargeType = ({ admin }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('/api/admin/hospitalchargetype-store', formSave);
    ...
    const Updatedata = (e, id) => {
        ...
        axios.post(`/api/admin/hospitalchargetype-update/${id}`, formSave).then(res => fetchData()).catch(error => console.log(error))
    }
    const DeleteData = (e, id) => {
        e.preventDefault();

        axios.post(`/api/admin/hospitalchargetype-delete/${id}`)
            .then(response => {
