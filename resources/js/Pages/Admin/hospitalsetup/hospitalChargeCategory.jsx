...
const hopitalChargeType = ({ admin, chargetype }) => {
    ...
    const fetchData = () => {
        axios.post('/api/admin/hospitalchargeCategory-fetch').then(res => {
            console.log(res)
            setData(res.data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('/api/admin/hospitalchargeCategory-store', formSave);
    ...
    const Updatedata = (e, id) => {
        ...
        axios.post(`/api/admin/hospitalchargeCategory-update/${id}`, formSave).then(res => fetchData()).catch(error => console.log(error))
    }
    const DeleteData = (e, id) => {
        e.preventDefault();

        axios.post(`/api/admin/hospitalchargeCategory-delete/${id}`)
            .then(response => {
...
export default hopitalChargeType;